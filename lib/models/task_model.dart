...
extension TaskPriorityX on TaskPriority {
  ...
  Color get color {
    switch (this) {
      case TaskPriority.low:
        return const Color(0xFF3DF5A5); // lime
      case TaskPriority.medium:
        return const Color(0xFF5B8CFF); // indigo
      case TaskPriority.high:
        return const Color(0xFFFFB443); // amber
      case TaskPriority.urgent:
        return const Color(0xFFFF5C7A); // rose
    }
  }
}
...
extension TaskStatusX on TaskStatus {
  ...
  Color get color {
    switch (this) {
      case TaskStatus.pending:
        return const Color(0xFF9AA0C8);
      case TaskStatus.inProgress:
        return const Color(0xFF22E3F5); // cyan
      case TaskStatus.completed:
        return const Color(0xFF3DF5A5); // lime
      case TaskStatus.cancelled:
        return const Color(0xFF6F76A6);
    }
  }
}
